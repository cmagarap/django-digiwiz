...
urlpatterns = [
    ...
    path('teacher/', include(([
        ...
        path('course/<int:pk>/lesson/add/', teachers.add_lesson, name='add_lesson'),
        path('course/<int:course_pk>/lesson/<int:lesson_pk>/', teachers.edit_lesson, name='edit_lesson'),
        path('course/<int:course_pk>/lesson/<int:lesson_pk>/delete/',
             teachers.LessonDeleteView.as_view(), name='delete_lesson'),
